  ...
  <div class="shadow-md rounded-b-[20px]">
    ...
    <div class="my-[15px] px-[20px] pb-[20px]">
      <div class="flex items-center justify-between text-gray">
        ...
        <div class="bg-[#f2f2f2] px-3 py-1 rounded">{{ date }}</div>
        <img class="w-[15px]" src="dispatching_clock.png" alt="icon" />
        <div class="bg-[#f2f2f2] px-3 py-1 rounded">{{ time }}</div>
        <img class="w-[15px]" src="dispatching_box.png" alt="icon" />
        <div class="bg-[#f2f2f2] px-3 py-1 rounded">{{ kg }}</div>
      </div>
      <Divider dashed="true" class="border-primary" />
      <div class="flex items-center text-primary font-bold gap-2">
        <div class="bg-[#f2f2f2] px-3 py-[7px] rounded basis-1/5 text-center rounded-l-[10px]">{{ resturant.bu }}</div>
        <div class="bg-[#f2f2f2] px-3 py-[7px] rounded basis-2/5 text-center">{{ resturant.number }}</div>
        <div class="bg-[#f2f2f2] px-3 py-[5px] basis-2/5 rounded-r-[10px] text-center">{{ resturant.name }}</div>
      </div>
